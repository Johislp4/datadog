    ...
    <table border="1">
        ...
        while ($reg = mysqli_fetch_assoc($registro)) {
            ...
            <tr>
                ...
                <td><button data-user="<?php echo $reg['ID']?>" class='btn btn-success btn-modify'">Actualizar</button></td>
...
<div class="modal fade" id="modalUpdate" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="update.php" enctype="multipart/form-data" method="post" id="formUpdate" style="margin-bottom: 17px">
